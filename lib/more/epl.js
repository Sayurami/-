...
const apiKey = '4d3d074f107f44e09123d19ed6a89950'; // Replace with your API key
...
async function getTopScorers() {
    const data = await fetchFootballData('competitions/PL/scorers');
    const competition = data.competition?.name || 'Unknown League';
...
async function getMatches() {
    const data = await fetchFootballData('competitions/PL/matches');
    const competition = data.competition?.name || 'Unknown League';
