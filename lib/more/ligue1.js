...
// Get Ligue 1 Matches
async function fl1Matches() {
    const data = await fetchFootballData('competitions/FL1/matches');
    const competition = data.competition?.name || 'Unknown Competition';
...
async function fl1TopScorers() {
    const data = await fetchFootballData('competitions/FL1/scorers');
    const competition = data.competition?.name || 'Unknown Competition';
...
// Get Ligue 1 Upcoming Matches
async function fl1UpcomingMatches() {
    const data = await fetchFootballData('competitions/FL1/matches');
    const competition = data.competition?.name || 'Unknown Competition';
