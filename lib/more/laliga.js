...
// Get La Liga Matches
async function pdMatches() {
    const data = await fetchFootballData('competitions/PD/matches');
    const competition = data.competition?.name || 'Unknown Competition';
...
async function pdTopScorers() {
    const data = await fetchFootballData('competitions/PD/scorers');
    const competition = data.competition?.name || 'Unknown Competition';
...
// Get La Liga Upcoming Matches
async function pdUpcomingMatches() {
    const data = await fetchFootballData('competitions/PD/matches');
    const competition = data.competition?.name || 'Unknown Competition';
