...
const blazingdrive = async (prompt) => {
  const apiUrl = `https://zaikyoov3-up.up.railway.app/api/blazingdrive?prompt=${encodeURIComponent(prompt)}`;
