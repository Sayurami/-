...
const fluxproultra = async (prompt) => {
  const apiUrl = `https://api.giftedtech.web.id/api/ai/sd?apikey=gifted&prompt=${encodeURIComponent(prompt)}`;
